	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		main.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Scorel2.this, MyList.class);
				myapp.empty();
		...
		if (wcon == 1) {
			...
			correct.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					// TODO Auto-generated method stub
					Intent intent = new Intent(Scorel2.this, ScoreWord.class);
			...
			review.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					myapp.set(3, Integer.toString(3));

					Intent intent = new Intent(Scorel2.this, MissRoot.class);
					startActivity(intent);
					finish();
				}
			});
			...
			if (scorenum < 100) {
				...
				review.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						myapp.empty1();
						Intent intent = new Intent(Scorel2.this,
								Idroortsl2.class);
