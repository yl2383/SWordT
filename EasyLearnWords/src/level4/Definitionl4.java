...
public class Definitionl4 extends Activity {
	...
	CountDownTimer timer = new CountDownTimer(15000, 1000) { // the total 15s, to complete the every word test.
		...
		public void onFinish() {
			...
			Intent intent = new Intent(Definitionl4.this, Definitionl4.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
				...
				public void onClick(View v) {
					...
					if (key.equals(words[wordnum - 1][1])) { // 做对了
						...
						if (!words[wordnum][0].equals("")) {
							...
							intent = new Intent(Definitionl4.this,
									Idroortsl4.class);
					...
					if (!key.equals(words[wordnum - 1][1])) { // 错词循环下做错了
						...
						defrepeat(1); // 这是做错了加1
						Intent intent = new Intent(Definitionl4.this,
								Definitionl4.class);
						startActivity(intent);
						myapp.setscore(0, clicknum + 1);
						myapp.setdefwordscore(0, defwordclicknum + 1);
		...
		wenhaoButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				alertdDialog = new AlertDialog.Builder(Definitionl4.this)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.level) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Definitionl4.this, Play.class);
			startActivity(intent);
			finish();
		}
		...
		if (id == R.id.PlayStudyReview) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Definitionl4.this, MyList.class);
			startActivity(intent);
			finish();
		}
		...
		if (id == R.id.listpage) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Definitionl4.this, Listselectactivity.class);
			startActivity(intent);
			finish();
		}
		...
		if (id == R.id.coursepage) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Definitionl4.this, MainActivity.class);
			startActivity(intent);
			finish();
		}
