...
sleeptime= Long.parseLong(this.getString(R.string.sleeptime));
		...
		wenhaoButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				alertdDialog = new AlertDialog.Builder(Idroortsl4.this)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (id == R.id.level) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Idroortsl4.this, Play.class);
			startActivity(intent);
			finish();
		}
		...
		if (id == R.id.PlayStudyReview) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Idroortsl4.this, MyList.class);
			startActivity(intent);
			finish();
		}
		...
		if (id == R.id.listpage) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Idroortsl4.this, Listselectactivity.class);
			startActivity(intent);
			finish();
		}
		...
		if (id == R.id.coursepage) {
			...
			myapp.stoplevelmusic();
			myapp.empty();
			Intent intent = new Intent(Idroortsl4.this, MainActivity.class);
			startActivity(intent);
			finish();
		}
		if (id == R.id.Exit) {
