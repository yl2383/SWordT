	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		main.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Scorel7.this, MyList.class);
				myapp.empty();
		...
		if (wcon == 1) {
			...
			correct.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					// TODO Auto-generated method stub
					Intent intent = new Intent(Scorel7.this, ScoreWord.class);
			...
			review.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					myapp.set(3, Integer.toString(8));

					double h = Math.random();

					if (h < 0.5) {
						Intent intent = new Intent(Scorel7.this,
								Definitionl8.class);
						...
						Intent intent = new Intent(Scorel7.this, Wordsl8.class);
						startActivity(intent);
					}
